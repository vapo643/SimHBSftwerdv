 ...
 */
router.post("/:id/observacoes", jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.put("/parcelas/:parcelaId", jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const success = await cobrancasService.updateParcelaStatus(
      parseInt(parcelaId),
      status,
      {
 ...
 */
router.post("/:id/solicitacoes", jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.get("/stats/overdue", jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.post("/batch/payment-update", jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
