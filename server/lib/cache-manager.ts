  ...
  private async initializeRedis() {
    try {
      ...
      this.redis.on('error', (error) => {
        ...
        this.stats.errors++;
        console.warn('[CACHE] Redis connection error, falling back to database:', error.message);
      });
      ...
      this.isRedisAvailable = false;
      console.warn('[CACHE] Redis initialization failed, running without cache:', error);
    }
  }
