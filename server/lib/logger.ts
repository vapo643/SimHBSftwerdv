...
export const logError = (message: string, error: Error | any, metadata?) => {
...
export const logWarn = (message: string, metadata?) => {
...
export const logMetric = (metricName: string, value: number, unit: string, metadata?) => {
  logger.info('📊 Metric', {
    metric: metricName,
    value,
    unit,
