...
console.log('🔍 [AUDIT-PRORROGAR] Dados recebidos do frontend:', JSON.stringify({
...
console.log('🔍 [AUDIT-PRORROGAR] Estado atual do boleto:', JSON.stringify({
...
console.log('🔍 [AUDIT-INTER] Payload Exato Enviado:', JSON.stringify({
...
console.log('🔍 [AUDIT-PRORROGAR] Resultado da verificação na API:', JSON.stringify({
  codigoSolicitacao: '44a467d1-e93f-4e91-b1f9-c79438ef5eea',
...
console.log('\n🔍 [AUDIT-PRORROGAR] Verificação do banco de dados local:', JSON.stringify({
  codigoSolicitacao: '44a467d1-e93f-4e91-b1f9-c79438ef5eea',
...
console.log('🔍 [AUDIT-PRORROGAR] Resumo:', JSON.stringify({
  totalProcessados: 1,
  sucessos: 1,
  falhas: 0,
  taxaSucesso: '100.0%'
...
console.log('🔍 [AUDIT-PRORROGAR] Detalhes da auditoria:', JSON.stringify([
  {
    codigoSolicitacao: '44a467d1-e93f-4e91-b1f9-c79438ef5eea',
    parcela: 4,
...
setTimeout(() => {
  ...
  const dadosQuitacao = {
    ...
    desconto: 500.00,
    novasParcelas: [
      { valor: 250.00, dataVencimento: '2025-09-15' },
      { valor: 250.00, dataVencimento: '2025-10-15' }
    ]
  };

  console.log('🔍 [AUDIT-QUITACAO] ====== INÍCIO DA QUITAÇÃO COM DESCONTO ======');
  console.log('🔍 [AUDIT-QUITACAO] Dados recebidos do frontend:', JSON.stringify({
  ...
  console.log('\n🔍 [AUDIT-QUITACAO] Análise da dívida atual:', JSON.stringify({
    quantidadeBoletosAtivos: 3,
    valorRestanteDivida: 1000.00,
    valorDesconto: 500.00,
    percentualDesconto: '50.0%',
    novoValorTotal: 500.00
  }, null, 2));

  console.log('\n🔍 [AUDIT-QUITACAO] Cancelando boleto antigo:', JSON.stringify({
  ...
  console.log('🔍 [AUDIT-QUITACAO] Verificação do cancelamento:', JSON.stringify({
    codigoSolicitacao: 'boleto-123-parcela-1',
  ...
  console.log('\n🔍 [AUDIT-QUITACAO] Criando novo boleto 1/2:', JSON.stringify({
    parcela: 1,
    valor: 250.00,
    dataVencimento: '2025-09-15'
  }, null, 2));

  console.log('🔍 [AUDIT-QUITACAO] Resposta da criação do boleto:', JSON.stringify({
    codigoSolicitacao: 'novo-boleto-quit-1',
    sucesso: true
  }, null, 2));

  console.log('🔍 [AUDIT-QUITACAO] Verificação do novo boleto na API:', JSON.stringify({
    codigoSolicitacao: 'novo-boleto-quit-1',
  ...
  console.log('\n🔍 [AUDIT-QUITACAO] Criando novo boleto 2/2:', JSON.stringify({
    parcela: 2,
    valor: 250.00,
  ...
  console.log('\n🔍 [AUDIT-QUITACAO] Verificação do banco de dados local:', JSON.stringify({
    totalBoletosAntes: 3,
  ...
  console.log('🔍 [AUDIT-QUITACAO] Resumo:', JSON.stringify({
    valorDividaOriginal: 1000.00,
    descontoAplicado: 500.00,
    percentualDesconto: '50.0%',
  ...
  console.log('🔍 [AUDIT-QUITACAO] Detalhes da auditoria:', JSON.stringify({
    valorRestanteDivida: 1000.00,
    percentualDesconto: '50.0%',
    cancelamentos: [
      {
