...
export const CCB_COMPLETE_MAPPING = {
  ...
  // =====================================================
  numeroCcb: {
    x: 450, y: 750, fontSize: 12, fontWeight: 'bold' as const,
    alignment: 'right' as const
  },
  
  dataEmissao: {
    x: 450, y: 720, fontSize: 11,
    alignment: 'right' as const
  },
  ...
  // --- Pessoa Física ---
  devedorNome: {
    x: 120, y: 680, fontSize: 11, maxWidth: 400,
    fontWeight: 'normal' as const
  },
  
  devedorCpf: {
    x: 120, y: 655, fontSize: 10,
  },
  
  devedorRg: {
    x: 280, y: 655, fontSize: 10,
  },
  
  devedorRgExpedidor: {
    x: 380, y: 655, fontSize: 10,
  },
  
  devedorNacionalidade: {
    x: 120, y: 630, fontSize: 10,
  },
  
  devedorEstadoCivil: {
    x: 250, y: 630, fontSize: 10,
  },
  
  devedorProfissao: {
    x: 380, y: 630, fontSize: 10,
  },
  
  // --- Endereço do Devedor ---
  devedorEndereco: {
    x: 120, y: 605, fontSize: 10, maxWidth: 200,
  },
  
  devedorNumero: {
    x: 320, y: 605, fontSize: 10,
  },
  
  devedorComplemento: {
    x: 380, y: 605, fontSize: 10,
  },
  
  devedorBairro: {
    x: 120, y: 580, fontSize: 10,
  },
  
  devedorCidade: {
    x: 280, y: 580, fontSize: 10,
  },
  
  devedorUf: {
    x: 420, y: 580, fontSize: 10,
  },
  
  devedorCep: {
    x: 450, y: 580, fontSize: 10,
  },
  
  devedorTelefone: {
    x: 120, y: 555, fontSize: 10,
  },
  
  devedorEmail: {
    x: 280, y: 555, fontSize: 10, maxWidth: 200,
  },
  ...
  valorPrincipal: {
    x: 200, y: 480, fontSize: 12, fontWeight: 'bold' as const,
    alignment: 'right' as const
  },
  
  valorPrincipalExtenso: {
    x: 120, y: 455, fontSize: 10, maxWidth: 400,
    multiline: true
  },
  
  dataVencimento: {
    x: 350, y: 480, fontSize: 11,
  },
  
  jurosAoMes: {
    x: 200, y: 430, fontSize: 11,
    alignment: 'right' as const
  },
  
  jurosAoAno: {
    x: 350, y: 430, fontSize: 11,
  },
  
  multa: {
    x: 200, y: 405, fontSize: 11,
  },
  
  taxaAdministracao: {
    x: 350, y: 405, fontSize: 11,
  },
  
  iof: {
    x: 200, y: 380, fontSize: 11,
  },
  
  cetMensal: {
    x: 350, y: 380, fontSize: 11,
  },
  
  cetAnual: {
    x: 450, y: 380, fontSize: 11,
  },
  
  valorTotalFinanciado: {
    x: 200, y: 355, fontSize: 12, fontWeight: 'bold' as const,
    alignment: 'right' as const
  },
  
  numeroParcelas: {
    x: 350, y: 355, fontSize: 11,
  },
  
  valorParcela: {
    x: 450, y: 355, fontSize: 11,
    alignment: 'right' as const
  },
  
  formaPagamento: {
    x: 120, y: 330, fontSize: 10, maxWidth: 400,
  },
  ...
  // --- PIX ---
  pixChave: {
    x: 120, y: 280, fontSize: 10, maxWidth: 300,
  },
  
  pixTitular: {
    x: 120, y: 255, fontSize: 10, maxWidth: 300,
  },
  
  // --- Dados Bancários ---
  banco: {
    x: 120, y: 280, fontSize: 10,
  },
  
  agencia: {
    x: 280, y: 280, fontSize: 10,
  },
  
  conta: {
    x: 350, y: 280, fontSize: 10,
  },
  ...
  credorNome: {
    x: 120, y: 200, fontSize: 11, fontWeight: 'bold' as const,
    maxWidth: 300
  },
  
  credorCnpj: {
    x: 120, y: 175, fontSize: 10,
  },
  
  credorEndereco: {
    x: 280, y: 175, fontSize: 10, maxWidth: 200,
  },
  ...
  localAssinatura: {
    x: 120, y: 120, fontSize: 10,
  },
  
  dataAssinatura: {
    x: 280, y: 120, fontSize: 10,
  },
  
  testemunha1Nome: {
    x: 120, y: 80, fontSize: 9,
  },
  
  testemunha1Cpf: {
    x: 120, y: 65, fontSize: 9,
  },
  
  testemunha2Nome: {
    x: 320, y: 80, fontSize: 9,
  },
  
  testemunha2Cpf: {
    x: 320, y: 65, fontSize: 9,
  },
  ...
  observacoes: {
    x: 120, y: 300, fontSize: 9, maxWidth: 400,
    multiline: true
  },
} as const;
 ...
 */
export function offsetCoordinates(position: FieldPosition, offsetX: number, offsetY: number): FieldPosition {
  return {
    ...position,
