...
export const pendenciarPropostaUseCase = () =>
  container.resolve(TOKENS.PENDENCIAR_PROPOSTA_USE_CASE);
export const submitForAnalysisUseCase = () =>
  container.resolve(TOKENS.SUBMIT_FOR_ANALYSIS_USE_CASE);
