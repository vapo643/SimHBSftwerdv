...
export const EtapaFormalizacaoControl: React.FC<EtapaFormalizacaoControlProps> = ({
  ...
  return (
    <Card className={`p-4 ${!habilitada ? 'opacity-50' : ''} ${concluida ? 'bg-green-900/20 border-green-700' : 'bg-gray-800 border-gray-700'}`}>
      ...
      {etapa === 'ccb_gerado' && concluida && (
        <div className="mt-3 p-3 bg-blue-900/20 rounded-md border border-blue-700">
      ...
      {etapa === 'assinatura_eletronica' && concluida && (
        <div className="mt-3 p-3 bg-purple-900/20 rounded-md border border-purple-700">
      ...
      {etapa === 'biometria' && concluida && (
        <div className="mt-3 p-3 bg-green-900/20 rounded-md border border-green-700">
