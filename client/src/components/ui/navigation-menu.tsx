...
const _navigationMenuTriggerStyle = cva(
  'data-[state=open]:bg-accent/50 group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-accent-foreground data-[state=open]:hover:bg-accent data-[state=open]:focus:bg-accent'
);
...
export {
  _navigationMenuTriggerStyle,
  _NavigationMenu,
  _NavigationMenuList,
  _NavigationMenuItem,
  _NavigationMenuContent,
  _NavigationMenuTrigger,
  _NavigationMenuLink,
  _NavigationMenuIndicator,
  _NavigationMenuViewport,
};
