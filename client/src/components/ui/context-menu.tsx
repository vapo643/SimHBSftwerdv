...
const _ContextMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
  return (
    <span
...
export {
  ...
  _ContextMenuPortal,
  _ContextMenuSub,
  _ContextMenuSubContent,
  _ContextMenuSubTrigger,
  _ContextMenuRadioGroup,
};
