...
const mockData = [
  { id: 'PROP-098', data: '2025-07-17', cliente: 'Empresa A', valor: 'R$ 1.500,00', dadosBancarios: 'Banco X, Ag 0001 C/C 12345-6', status: 'Pronto para Pagamento' },
  { id: 'PROP-101', data: '2025-07-16', cliente: 'Empresa B', valor: 'R$ 12.000,00', dadosBancarios: 'Banco Y, Ag 0002 C/C 78910-1', status: 'Aprovado' },
  { id: 'PROP-105', data: '2025-07-15', cliente: 'Empresa C', valor: 'R$ 8.250,00', dadosBancarios: 'Banco Z, Ag 0003 C/C 11223-3', status: 'Pronto para Pagamento' },
];
